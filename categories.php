				...
				<div class="row">
					<div class="col">
						...
						<div class="product_grid">
							...
							<?php
								$query = 
								"select * from barang b,pengarang p
				...
				<div class="row icon_box_row">
					...
					<div class="col-lg-4 icon_box_col">
						<div class="icon_box">
							...
							<div class="icon_box_text">
								<p>Khawatir barang tidak cocok? Jangan khawatir, karena apapun alasannya retur di Dalanta Horas gratis & mudah!</p>
							</div>
						</div>
					</div>
