                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu show" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="../barang/table_barang.php">Data barang</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                            $query = 
                                            "select t.id_transaksi,c.nama_customer,b.nama_barang,t.tgl_transaksi,t.jumlah,t.total from transaksi t,customer c,barang b
                                            where t.id_customer = c.id_customer AND
                                            b.id_barang = t.id_barang";
