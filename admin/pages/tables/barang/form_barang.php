...
<head>
    ...
    <title>Admin | Dalanta Horas</title>
</head>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="../../../dashboard.php">Dalanta Horas</a>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu show" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="table_barang.php">Data barang</a>
                                        </li>
                                        <li class="nav-item">
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="process/add_barang.php" method="POST" enctype="multipart/form-data">

                                    <?php 
                                    $tampilkan_isi = "select count(id_barang) as jumlah from barang;";
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="id_barang" class="form-control" value="B-<?php echo $no+$jumlah ?>"
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="nama_barang" class="form-control" placeholder="Judul barang"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label">Deskripsi barang</label>
                                        <div class="col-md-9">
                                            <textarea name="deskripsi" cols="30" rows="10" class="form-control"
                                                placeholder="Deskripsi barang" required></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mt-5">
                                        <div class="col-md-6">
                                            <!-- back to home -->
                                            <a name="backBtn" id="backBtn" class="btn btn-dark btn-block btn-lg" href="table_barang.php"
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            Copyright © 2018 Dalanta Horas. All rights reserved.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        </div>
                    </div>
