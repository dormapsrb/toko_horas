                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu show" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="../barang/table_barang.php">Data barang</a>
                                        </li>
                                        <li class="nav-item">
                ...
                <div class="container-fluid dashboard-content ">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="table_barang.php" class="breadcrumb-link">Data
                                                    barang</a></li>
                    ...
                    <form action="process/edit_barang.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-xl-3">
                                <div class="card">
                                    <h5 class="card-header">Cover barang</h5>
                                    <div class="card-body">
                            ...
                            <div class="col-xl-9">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-form-label">Judul barang</label>
                                            <div class="col-md-9">
                                                <input type="text" name="nama_barang" class="form-control" placeholder="Judul barang"
                                                    value="<?php echo $item['nama_barang'] ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mt-5">
                                            <div class="col-md-6">
                                                ...
                                                <a name="backBtn" id="backBtn" class="btn btn-dark btn-block btn-lg"
                                                    href="table_barang.php" role="button">Kembali</a>
                                            </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    Copyright © 2021 Dalanta Horas. All rights reserved.
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                </div>
            </div>
