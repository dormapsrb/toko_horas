                            ...
                            <div class="card-body">
                                ...
                                <table id="tabell" class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            $query = 
                                            "SELECT * FROM barang WHERE deleted = 0
                                            ORDER BY id_barang";
                                            ...
                                            if (mysqli_num_rows($result) > 0)
                                            {
                                                ...
                                                while($row = mysqli_fetch_assoc($result))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href='form_edit_barang.php?id_barang=$id_barang' class='btn btn-warning'>Update</a>
                                                            <a href='process/delete_barang.php?id_barang=$id_barang' class='btn btn-danger'>Delete</a>
                                                        </td>
                                                    </tr>
                                                    ";
                                                }
