...
{  
        ...
        //    echo 'alert("Anda Login sebagai ADMIN")';  
        //    echo '</script>';
...
<head>
    ...
    <title>Admin | Dalanta Horas<</title> </head> <body>
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <div id="submenu-5" class="collapse submenu" style="">
                                            <ul class="nav flex-column">
                                                <li class="nav-item">
                                                    <a class="nav-link" href="pages/tables/barang/table_barang.php">Data
                                                        barang</a>
                                                </li>
                                                <li class="nav-item">
                        ...
                        <div class="container-fluid dashboard-content ">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p><b>Toko barang Dalanta Horas</b> merupakan aplikasi Toko barang berbasis
                                            web. Di aplikasi ini, terdapat pembagian user/multi user yaitu
                                            Admin dan customer. Selain itu aplikasi ini terdiri
                                            dari menu barang, Customer, Kategori, Penerbit, Pengarang, User.
                                            Diharapkan aplikasi ini dapat memudahkan pekerjaan dalam
                                            melakukan pendataan barang,pengarang,penulis, dan pembayaran.</p>
