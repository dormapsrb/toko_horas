...
else
{
    ...
    foreach ($_SESSION["keranjang"] as $id_barang => $jumlah) 
    {
        ...
        $query = $con->query("INSERT INTO transaksi (id_transaksi, id_customer, id_barang, tgl_transaksi, jumlah, total) VALUES ('TR-$no', '$id_customer','$id_barang',now(), $jumlah, $subharga)");
