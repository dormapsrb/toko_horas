					...
					<div class="col-lg-6">
						<div class="details_content">
							...
							<div class="product_quantity_container">
								<div class="button cart_button"><a href="process/update-cart.php?id_barang=<?php echo $id_barang; ?>">Add to cart</a></div>
							</div>
							<?php } ?>
						</div>
					</div>
				...
				<div class="row">
					<div class="col">
						...
						<div class="product_grid">
							<?php
								$query = 
								"SELECT * from barang WHERE id_kategori='$kategori' AND id_barang!='$id_barang'";
									...
									while($row = mysqli_fetch_assoc($result))
									{
										...
										<div class='product'>
											...
											<div class='product_content'>
												<div class='product_title'><a href='product.php?id_barang=$id_barang'>".$row['nama_barang']."</a></div>
